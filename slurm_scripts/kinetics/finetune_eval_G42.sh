#!/bin/bash
#SBATCH --job-name=finetune_eval_videomae_s1
...
python ./tools/run_net.py --cfg ./configs/Kinetics/FINETUNE_divST_8x32_224_OLD.yaml \
NUM_GPUS 16 \
...
TRAIN.FINETUNE True \
OUTPUT_DIR './results/svt_videomae_30_slice_1_finetune'
